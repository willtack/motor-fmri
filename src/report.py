        ...
        for i in range(0, len(run_list)):
            ...
            def append_task_section(sec_list, is_png):
                all_rois = ["whole brain", "broca's area", "inferior frontal gyrus", "middle frontal gyrus",
                            ...
                            "frontal lobe", "inferior temporal gyrus", "middle temporal gyrus", "superior temporal gyrus",
                            "planum temporale",
                            "angular gyrus"]
                all_masks = [lhem_mask, rhem_mask, lba_mask, rba_mask, lifg_mask, rifg_mask, lmfg_mask, rmfg_mask, lsfg_mask,
                             rsfg_mask,
                             lfront_mask, rfront_mask, litg_mask, ritg_mask, lmtg_mask, rmtg_mask, lstg_mask, rstg_mask, lpt_mask,
                             rpt_mask,
                             lag_mask, rag_mask]
                rois = []
                masks = []
